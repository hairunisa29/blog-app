...
<div class="container-fluid py-24 px-72">
    ...
    <form method="post" action="{{ route('articles.store') }}" class="flex flex-col gap-8 mt-8">
        @csrf
        <div>
        ...
        <button type="submit" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 focus:outline-none">Create</button>
    </form>
